# Run Puppeteer Jest Tests with HyperExecute on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Puppeteer Jest tests using HyperExecute. This sample shows how to configure Puppeteer + Jest + HyperExecute to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/hyperexecute-puppeteer-jest-sample && cd hyperexecute-puppeteer-jest-sample
npm install
```
