...
[<img alt="Run in Gitpod" width="200 px" align="center" src="images/Gitpod.svg" />](https://hyperexecute.lambdatest.com/hyperexecute/jobs?type=gitpod&framework=Jest&frameworkType=Puppeteer)
---
...
# How to run Puppeteer automation tests on HyperExecute (using Puppeteer-Jest framework) — TestMu AI (Formerly LambdaTest)
...
# Matrix Execution with Puppeteer-Jest
